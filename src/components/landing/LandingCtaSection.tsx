  ...
  return (
    <section className="rounded-xl bg-surface-background p-6 md:p-8 text-center space-y-4">
      ...
      <button
        ...
        className="inline-flex items-center justify-center rounded-full bg-brand-forest px-6 py-3 text-base md:text-lg font-semibold text-white hover:bg-brand-sage transition"
      >
